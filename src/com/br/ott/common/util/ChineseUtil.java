...
/**
 * 文件名：Chinese.java 版权：BoRuiCubeNet. Copyright 2014-2015,All rights reserved
 * 公司名称：青岛博瑞立方科技有限公司 创建人：pananz 创建时间：2016-10-18
 */
public class ChineseUtil {
	 ...
	 * @return String
	 */
	public static String getSellingHead(String chs) {
		String key, value;
		StringBuilder buffer = new StringBuilder();
		for (int i = 0; i < chs.length(); i++) {
			key = chs.substring(i, i + 1);
	...
	public static void main(String[] args) {
		System.out.println("sss:" + ChineseUtil.getSellingHead("开始扫描要下载图片的资产 "));
