...
public class JedisUtil {
	...
	public static void main(String[] args) {
		...
		hmap.put("id", "0007ed2888644d639d129aefbe1e7412");
		hmap.put("path",
				"movies/201312/1204/Will.It.Snow.for.Christmas.E14.720p.HDTV.x264-kurama.ts");
		hmap.put("size", "0");
		hmap.put("server", "[5001,5002]");
		// hmset("0007ed2888644d639d129aefbe1e7412",hmap);
	}
	 ...
	 *            超时时间
	 */
	public JedisUtil(String ip, int prot, int timeout, String pwd, int dbindex) {
		if (pool == null) {
			...
			pool = new JedisPool(config, ip, prot, timeout, pwd, dbindex);
		}
	}
